...
var createNewTaskElement=function(taskString){
  ...
  label.className="list-tasks__item-label";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("js-edit");
  //If class of the parent is .js-edit
  if(containsClass){
  ...
  //toggle .js-edit on the parent.
  listItem.classList.toggle("js-edit");
};
